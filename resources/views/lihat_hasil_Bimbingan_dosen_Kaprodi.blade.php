        ...
        <div class="bg-gradient-to-r from-blue-800 to-blue-600 p-4 flex items-center justify-between shadow-lg relative">
            <div class="flex items-center">
                <div class="bg-white p-2 rounded-full">
                    <img alt="Logo" class="w-10 h-10" height="50"
            ...
            <div class="absolute top-4 right-4 flex space-x-4">
                <a href="{{ route('bimbingan.indexKaprodi') }}">
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 space-x-2">
                                <a href="{{ route('bimbingan.show', $bimbingan->id) }}"
                                    class="bg-green-600 text-white py-1 px-3 rounded-md hover:bg-green-500 transition-colors duration-200">Lihat Detail</a>
