...
<header class="bg-blue-800 text-white p-4 flex items-center justify-between shadow-lg">
    ...
    <div class="flex space-x-3">
        <button onclick="window.location.href = '/kaprodi';"
...
<body class="bg-gray-100 font-sans">
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg">
            <form action="{{ route('pembimbing-akademik.index') }}" method="GET">
            ...
            <div class="overflow-x-auto">
                <form action="{{ route('pembimbing-akademik.storeMultiple') }}" method="POST">
                    ...
                    <div class="mt-4">
                        <label class="block text-blue-700 font-bold mb-2">Pilih Pembimbing Akademik</label>
                        <select name="dosen_id"
                            class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @foreach ($dosen as $dsn)
                    ...
                    <button type="submit" class="bg-green-500 text-white p-3 rounded-lg mt-4">Tambah Pembimbing ke
                        Terpilih</button>
                </form>
            </div>
        </div>
